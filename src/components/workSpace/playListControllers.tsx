...
export const PlayListController = () => {
  ...
  const tabs = [
    { title: "Фонове відео", component: isLocal ? <LocalVideoListController /> :  <VideoPlayListController /> },
    { title: "Фонова музика", component: isLocal ? <LocalAudioListController /> : <AudioPlayListController />},
    isLocal ? {title: "Фонове зображення", component: <LocalImageListController />} : null
  ];
      ...
      <div className="p-2 px-6" key={tab.title}>
        ...
        <ul
          className={
            ...
            (activeTabIndex === index ? "h-56 opacity-100" : "h-0 opacity-0")
          }
        >
          {tab.component}
        </ul>
